        ...
        <div class="main-right-inner">
            ...
            <div class="container-fluid">
                ...
                <div class="switch-board row js-switch-board">
                    ...
                    <div class="col-sm-10 col-sm-offset-2">
                        <form action="" method="post" class="form-horizontal switch-item active" novalidate
                              id="validate-form">
                            <input type="hidden" class="form-control" name="uid" id="uid" value="${user.id}">
                            <input type="hidden" class="form-control" name="phone" value="18170085548">
                            <div class="form-group">
                                <div class="col-sm-6 pwd-box">
                                    <input type="password" autocomplete="off" class="form-control" placeholder="输入新登录密码"
                                           id="pswd" name="password">
                                    <i class="ucenter_icon-pwd-show pwd-close js-toggle-pwd"></i>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-6 pwd-box">
                                    <input type="password" autocomplete="off" class="form-control"
                                           placeholder="请再次输入新登录密码" name="confirmPassword">
                                    <i class="ucenter_icon-pwd-show pwd-close js-toggle-pwd"></i>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-6">
                                    <div class="pwd-strength level0" id="pwd-status">
                                        <%-- <span class="pwd-strength-bar"></span>
                                         <p class="pwd-strength-text">密码等级 <span id="pwd-status-text">弱</span>，多字符组成的复杂密码更安全</p>
                                         <input type="text" id="pwdStatus" name="pwdStatus" style="display:none" value="弱" />--%>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-6 pt40">
                                    <input type="button" class="btn btn-info cus" onclick="update()" value="提交"
                                           id="sub-btn">
                                </div>
                            </div>
                        </form>
...
<script>
    ...
    function update() {
        ...
        $.post("${pageContext.request.contextPath}/user/updatePwd2",
            {"uid": uid, "password": password},
            function (data) {
                if (data.state == 1) {
                    alert(data.message);
                    //回到当前页
                    window.location.href = "${pageContext.request.contextPath}/main/toShowPwdVerifySuccess";

                }
                else {
                    alert(data.message);
                    window.location.href = "${pageContext.request.contextPath}/main/toShowPwdVerifyFalse";
                }
